...
(function ($) {
     ...
     */
    const ZenixVideoSlider = function ($scope, $) {
        const slider = $($('.zenix_video_slider', $scope)[0]);
        const sliderSettings = $($('.zenix_vs_wrapper', $scope)[0]).data('settings') || {};
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/zenix--video-slider.default', ZenixVideoSlider);
    });
})(jQuery);
