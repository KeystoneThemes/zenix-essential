(function ($) {
    ...
    var Wdb_Lottie = function ($scope, $) {
        let $container = $scope.find('.elementor-widget-container');
        let settings = JSON.parse( $scope.find('.wdb-lottie-wrp').attr('data-settings') ); 
        let s_id = '#wdb-lottie-player-'+$scope.attr('data-id');        
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wdb--lottie-animation.default', Wdb_Lottie);
    });
