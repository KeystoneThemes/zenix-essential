( function( $ ) {
  ...
  var WdbTHeader_Menu = function ($scope, $) {
      ...
      $(document).on('click', '.close', function(e){
        ...
        $('.wdb-header-pin-js').removeClass('active');
      }); 
      ...
      if (typeof(gsap) === "object") {
        ...
        if($( window ).width() >= 991) {
            ...
            gsap_container = gsap.to(".wdb-header-pin-js", {
              scrollTrigger: {
                trigger: ".body-wrapper",
                start: "top top",
                end: "bottom bottom",
                markers: false,
                pin: ".wdb-header-pin-js",
                pinSpacing: false,                
              },
            });  
        }
      ...
      window.addEventListener("resize", function(){
          ...
          this.setTimeout(function(){
            ...
            $scope.find('.pin-spacer .wdb-header-pin-js').removeAttr('style'); 
          },1000);
  ...
  $( window ).on( 'elementor/frontend/init', function() {
      elementorFrontend.hooks.addAction( 'frontend/element_ready/wdb--site-landing-page.default', WdbTHeader_Menu );
  } );
} )( jQuery );