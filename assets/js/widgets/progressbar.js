(function ($) {
     ...
     */
    var ZenixProgressBar = function ($scope, $) {
        let wrapper = $scope.find('.zenix_progressbar');
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/zenix--progressbar.default', ZenixProgressBar);
    });
})(jQuery);