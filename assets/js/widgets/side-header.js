...
(function ($) {
     ...
     */
    const ZenixSideHeader = function ($scope, $) {
        let menu_open = $('.menu--open', $scope);
        let menu_close = $('.menu--close', $scope);
        let side_header = $('.zenix--side-header', $scope);
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/zenix--side-header.default', ZenixSideHeader);
    });
})(jQuery);