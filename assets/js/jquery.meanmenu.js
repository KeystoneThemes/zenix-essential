  ...
  $.fn.meanmenu = function (options) {
    ...
    return this.each(function () {
      ...
      var meanOriginal = function () {
        ...
        jQuery(meanMenu).find('ul li > .wdb-mg-megamenu-section').each(function(){
      ...
      var showMeanMenu = function () {
        ...
        if (currentWidth <= meanScreenWidth) {       
          ...
          jQuery(meanContainer).addClass('wdb-offcanvas-container');
          ...
          if (meanShowChildren) {
            ...
            if (meanExpandableChildren) {
              // '.mean-nav ul ul , .mean-nav ul .wdb-mg-megamenu-section'
              jQuery('.mean-nav ul ul , .mean-nav ul .wdb-mg-megamenu-section').each(function () {
              ...
              jQuery('.mean-expand').on("click" ,function (e) {
                ...
                if (jQuery(this).hasClass("mean-clicked")) {
                  ...
                  if( disable_megamenu_mobile == 'yes' || disable_megamenu_mobile == 'default' ){     
                    ...
                    jQuery(this).parents('li').find('.wdb-mg-megamenu-section').slideUp(300, function () { });
                  }
                  ...
                  if( disable_megamenu_mobile == 'yes' || disable_megamenu_mobile == 'default'){                  
                    jQuery(this).parent('li').find('ul.dp-menu:first,ul.sub-menu:first').slideDown(300, function () {
                    
                    });
                  }else{
                    jQuery(this).parents('li').find('.wdb-mg-megamenu-section').slideDown(300, function () { });
                  }
                }
