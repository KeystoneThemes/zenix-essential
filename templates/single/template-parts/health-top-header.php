...
<?php
  ...
  $blog_cat_show    = zenix_option('blog_category','yes');
  $cat              = get_the_category();
  $blog_cat_single  = zenix_option('blog_category_single','no');
          ...
          <div class="col-xxl-12">
            <div class="content">
              ...
              <p><?php
                ...
                echo esc_html__('by','zenix-essential') .' '. $get_author; 
                }
              ?><span></span><?php echo get_the_date(get_option( 'date_format' )); ?>
               <?php if( zenix_option('blog_comment',0) ){ ?>
                <span></span>
                <?php $comments_number = get_comments_number();
                  echo $comments_number > 1 ? sprintf(esc_html__('%s comments','zenix-essential'),$comments_number) : sprintf(esc_html__('%s comment','zenix-essential'),$comments_number);
                } ?>
