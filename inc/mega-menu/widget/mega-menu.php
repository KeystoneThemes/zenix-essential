...
namespace WDB\Megamenu\Widgets;
...
use Wdb\Mega_Menu\Mega_Menu_Nav_Walker;
 ...
 * @since 1.0.0
 */
class wdb_Header_Mega_Menu extends Widget_Base {
	...
	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Mega Menu' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'wdb-header-mega-menu', plugin_dir_url( __DIR__ ).'assets/header-menu.css' );
		return [ 'wdb-header-mega-menu' ];
	}

	public function get_script_depends() {
		wp_register_script( 'wdb-header-mega-menu', plugin_dir_url( __DIR__ ).'assets/header-menu.js', [ 'jquery','meanmenu' ], false, true );
		return [ 'wdb-header-mega-menu' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Disable Megamenu in Mobile', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'zenix-essential' ),
				'label_off' => esc_html__( 'No', 'zenix-essential' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'offcanvas_align',
			[
				'label'   => esc_html__('Animated Direction', 'zenix-essential'),
				'type'    => Controls_Manager::CHOOSE,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout ul li a' => 'color: {{VALUE}}',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mega Menu', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);

		$this->add_responsive_control(
			'mega_menu__wdb_container_style',
			[
				'label' => esc_html__( 'Container layout', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					...
					'position: fixed;
						width: 100%;					  
						left: 0;' => esc_html__( 'Full Width', 'zenix-essential' ),

				],
				'selectors' => [
					'{{WRAPPER}} .wdb-mg-megamenu-section' => '{{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'ega_menu__wdb_container_top',
			[
				'label' => esc_html__( 'Position Top', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-mg-megamenu-section' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);

		$this->add_responsive_control(
			'ega_menu__wdb_container_left',
			[
				'label' => esc_html__( 'Position Left', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-mg-megamenu-section' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'icon_list_typo',
				'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a i',
			]
		);
		$this->end_controls_tab();
