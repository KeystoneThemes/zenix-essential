...
final class _FW_Extensions_Manager
{
	...
	public function __construct()
	{
		...
		$hook_csf_fire = sprintf( 'csf_%s_saved' ,  ZENIX_OPTION_KEY);
		
		add_action($hook_csf_fire, function(){	
		
		    $active  = function_exists('zenix_option') ? zenix_option('theme_demo_activate', true) : false;
		    if($active){
	...
	public function _action_admin_notices() {
		...
		/**
		 * In v2.4.12 was done a terrible mistake  -Extensions-Approval/issues/160
