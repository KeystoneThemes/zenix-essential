...
?>
<h2 class="wdb-theme--title"><?php esc_html_e('Demo Content Install', 'fw') ?></h2>
...
<p></p>
<div class="theme-wdb-filter-area">	
	...
	<div class="search">
	  <div class="search-box">
	    <div class="search-field">
	      <input list="demo-items" id="wdb-demo-items-search-js" placeholder="Search..." class="input" type="text">	     
...
<div class="theme-browser rendered wdb-theme-browser" id="fw-ext-backups-demo-list">
<?php foreach ($demos as $demo): $counter++; ?>
	<div <?php echo $counter > 15 ? 'style="display:none"' : ''; ?> data-cat="<?php echo $demo->get_category(); ?>" class="theme fw-ext-backups-demo-item wdb-demo-item" id="demo-<?php echo esc_attr($demo->get_id()) ?>">
        ...
        <div class="theme-actions-wrapper">
            <h3 class="wdb-theme-name wdb-demo-tpl-name"><?php echo esc_html($demo->get_title()); ?></h3>
...
<?php if($counter > 15){ ?>
	<div class="wdb-demo-loadmore-wrapper">
		<a class="loadmore-wdb-demo" href="javascript:void(0)">
			Loadmore
		</a>
	</div>
<?php } ?>
