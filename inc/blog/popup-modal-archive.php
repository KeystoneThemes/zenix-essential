<?php 
  ...
  $json_data = zenix_get_config_value_by_name('elementor/archive');
  $args = array(
    'numberposts' => 15,
 ...
 document.addEventListener("DOMContentLoaded", function(event) {
    ...
    jQuery(document).on('click', '.wdb--blog-tpl-install-remote' ,function(e){     
       ...
       jQuery.ajax({
         type : 'post',        
         url : ajax_path,
         data : {action: "wdb_post_tpl_remote_import", tpl_id : jQuery(this).attr('data-id')},
...
<div class="wdb-modal wdb--remote-layouts">
  ...
  <div class="wdb-modal__inner">
    ...
    <h2><?php echo esc_html__('Blog Template Layout Import','zenix-essential') ?></h2>
