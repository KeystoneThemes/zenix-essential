<?php 
  ...
  $args = array(
    'numberposts' => 4,
    'post_type' => ['wdb-error-tpl'],
    'post_status' => array('publish'),
    'meta_key' => 'wdb_essential_settings_error_layoutactivate',
    'orderby' => 'meta_value_num',
  );
  
  $latest_posts = get_posts( $args );
  $active_id = get_option('wdb-elementor-error-layout-id');
  
  $hf_page  = admin_url( 'edit.php?post_type=wdb-error-tpl' );
...
?>
<style>
.wdb-error-tpl-wrapper .wdb--blog-builder-list {
    display: flex;
    gap: 80px;
    flex-wrap: wrap;
}
...
<div class="wdb-error-tpl-wrapper">
    <h4><a class="wdb-post-layout-import-modal button button-primary csf--button" data-id="error_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','zenix-essential') ?></a> </h4>
