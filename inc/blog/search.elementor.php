<?php 
  ...
  $args = array(
    'numberposts' => 4,
    'post_type' => ['wdb-search-tpl'],
    'post_status' => array('publish'),
    'meta_key' => 'wdb_essential_settings_search_layoutactivate',
    'orderby' => 'meta_value_num',
  );
  
  $latest_posts = get_posts( $args );
  $active_id = get_option('wdb-elementor-search-layout-id');
  
  $hf_page  = admin_url( 'edit.php?post_type=wdb-search-tpl' );
...
?>
<style>
.wdb-search-tpl-wrapper .wdb--blog-builder-list {
    display: flex;
    gap: 80px;
    flex-wrap: wrap;
}
...
<div class="wdb-search-tpl-wrapper">
    <h4><a class="wdb-post-layout-import-modal button button-primary csf--button" data-id="search_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','zenix-essential') ?></a> </h4>
