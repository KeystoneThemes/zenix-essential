...
class Banner_Breadcrumb extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'wdb--blog--banner--breadcrumb';
	}

	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Banner Breadcrumb' );
	}
	
	public function get_icon() {
		return 'wdb eicon-product-breadcrumbs';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Breadcrumb', 'zenix-essential' ),				
			]
		);
		...
		$this->add_control(
			'separetor_icon',
			[
				'label' => esc_html__( 'Separetor Icon', 'zenix-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'   => esc_html__( 'Author Heading', 'zenix-essential' ),
		...
		$this->add_control(
			'error_text',
			[
				'label'   => esc_html__( '404 Heading', 'zenix-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '404 Error',	
				'placeholder' => '404',	
			]
		...
		$this->add_control(
			'search_text',
			[
				'label'   => esc_html__( 'Search Heading', 'zenix-essential' ),
				'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
			'show_title',
			[
				'label' => esc_html__( 'Show Heading', 'zenix-essential' ),
		...
		$this->add_control(
			'dynamic_title',
			[
				'label' => esc_html__( 'Dynamic', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
			'static_text',
			[
				'label'   => esc_html__( 'Heading Text', 'zenix-essential' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'classes',
			[
				'label'   => esc_html__( 'CSS Classes', 'zenix-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'ai'      => [
					'active' => false,
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'zenix-essential' ),
		...
		$this->start_controls_section(
			'section_bread_style',
			[
				'label' => __( 'Breadcrumb Style', 'zenix-essential' ),
    		...
    		$this->add_control(
    			'link_hover_color',
    			[
    				'label'     => esc_html__( 'Link Hover Color', 'zenix-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Icon Options', 'zenix-essential' ),
            ...
            $this->add_control(
    			'title_sepe_color',
    			[
    				'label'     => esc_html__( 'Separetor Color', 'zenix-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
    		...
    		$this->add_control(
    			'sepe_icon',
    			[
    				'label' => esc_html__( 'Icon Padding', 'zenix-essential' ),
            ...
            $this->add_control(
                'wrapper_options',
                [
                    'label' => esc_html__( 'Wrapper', 'zenix-essential' ),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => __( 'Title Style', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'blend_mode',
			[
				'label'     => esc_html__( 'Blend Mode', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					''            => esc_html__( 'Normal', 'zenix-essential' ),
					'multiply'    => 'Multiply',
					'screen'      => 'Screen',
					'overlay'     => 'Overlay',
					'darken'      => 'Darken',
	...
	protected function render() {
        ...
        $separete_icon = zenix_render_elementor_icons($settings['separetor_icon']);
        wdb_get_breadcrumbs($separete_icon,30);
