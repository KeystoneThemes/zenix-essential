 ...
 * @since 1.0.0
 */
class Zenix_Case_Study_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Case Study', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-case-study', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-case-study-slider.css' );
		return [ 'zenix-case-study' ];
	}

	public function get_script_depends() {
		wp_register_script( 'zenix-case-study', ZENIX_ESSENTIAL_ASSETS_URL . '/js/widgets/zenix-case-study-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'zenix-case-study' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Case Study', 'zenix-essential' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtitle', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'space-between' => [
						'title' => esc_html__( 'Space Between', 'zenix-essential' ),
		...
		$this->add_responsive_control(
			'arrows_margin',
			[
				'label'      => esc_html__( 'Wrapper Margin', 'zenix-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel',
			[
				'class' => 'case-study-slider ' . $swiper_class,
