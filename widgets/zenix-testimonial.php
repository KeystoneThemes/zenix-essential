 ...
 * @since 1.0.0
 */
class Zenix_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Testimonial', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-testimonial', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-testimonial.css' );
		return [ 'zenix-testimonial' ];
	}

	public function get_script_depends() {
		wp_register_script( 'zenix-testimonial', ZENIX_ESSENTIAL_ASSETS_URL . '/js/widgets/zenix-testimonial.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'zenix-testimonial' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Testimonial', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'element_list',
			[
				'label'   => esc_html__( 'Testimonial Style', 'zenix-essential' ),
		...
		$repeater->add_control(
			'top_text',
			[
				'label' => esc_html__( 'Top Text', 'zenix-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Default Text ', 'zenix-essential' ),
			]
		);
		...
		$repeater->add_control(
			'testimonial_content',
			[
				'label'   => esc_html__( 'Feedback', 'zenix-essential' ),
		...
		$repeater->add_control(
			'testimonial_image',
			[
				'label'   => esc_html__( 'Client Image', 'zenix-essential' ),
		...
		$repeater->add_control(
			'testimonial_quote',
			[
				'label'   => esc_html__( 'Choose Quote', 'zenix-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_logo',
			[
				'label'   => esc_html__( 'Logo/Rating Image', 'zenix-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_job',
			[
				'label'       => esc_html__( 'Designation', 'zenix-essential' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
		...
		$this->add_control(
			'testimonials',
			[
				'label'   => esc_html__( 'Testimonials', 'zenix-essential' ),
		...
		$this->start_controls_section(
			'section_slide_style',
			[
				'label' => esc_html__( 'Slide', 'zenix-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zenix__testimonial-1 .slide::after, {{WRAPPER}} .zenix__testimonial-2 .slide::after'  => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'client_padding',
			[
				'label'      => esc_html__( 'Client Padding', 'zenix-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'top_text_show',
			[
				'label'     => esc_html__( 'Top Text Show', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'none',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'zenix-essential' ),
					'block' => esc_html__( 'Show', 'zenix-essential' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'img_show',
			[
				'label'     => esc_html__( 'Image Show', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'zenix-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_quote',
			[
				'label' => esc_html__( 'Quote', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'quote_show',
			[
				'label'     => esc_html__( 'Quote Show', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'zenix-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_logo',
			[
				'label' => esc_html__( 'Logo/Rating', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '4'],
				],
	...
	private function slider_controls() {
		...
		$this->add_control(
			'slide_effect',
			[
				'label'   => esc_html__( 'Effect', 'zenix-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__( 'Slide', 'zenix-essential' ),
					'cards'     => esc_html__( 'Cards', 'zenix-essential' ),
					'flip'      => esc_html__( 'Flip', 'zenix-essential' ),
					'fade'      => esc_html__( 'Fade', 'zenix-essential' ),
					'cube'      => esc_html__( 'Cube', 'zenix-essential' ),
					'coverflow' => esc_html__( 'CoderFlow', 'zenix-essential' ),
					'creative'  => esc_html__( 'Creative', 'zenix-essential' ),
				],
			]
		);
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows', 'zenix-essential' ),
		...
		$this->add_control(
			'dots_active_size',
			[
				'label'     => esc_html__( 'Active Size', 'zenix-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 5,
		...
		$this->add_responsive_control(
			'dots_left',
			[
				'label'      => esc_html__( 'Spacing Left', 'zenix-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'zenix_testimonial_wrapper zenix__testimonial-' . $settings['element_list'] ],
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'zenix_testimonial_slider ' . $swiper_class,
