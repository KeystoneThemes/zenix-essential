...
class Header_Menu extends Widget_Base {
	...
	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Header Navigation' );
	}
	...
	// 	wp_register_style( 'info-header-menu', ZENIX_ESSENTIAL_ASSETS_URL . 'css/header.css' );
	// 	return [ 'info-header-menu' ];
	// }
	
	public function get_script_depends() {
	    wp_register_script( 'wdb-header-menu', ZENIX_ESSENTIAL_ASSETS_URL. '/js/widgets/header-menu.js' , [ 'jquery','meanmenu' ], false, true );
		return [ 'wdb-header-menu' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label' => esc_html__( 'Layout Style', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'athletic__header-menu',
				'options' => [
					'athletic__header-menu' => esc_html__( 'Athletic', 'zenix-essential' ),
					'fashion__header-menu' => esc_html__( 'Fasion', 'zenix-essential' ),					
				],
			]
		);
        ...
        $this->add_control(
			'show_offcanvas',
			[
				'label' => esc_html__( 'Show menu in Offcanvas', 'zenix-essential' ),
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'space-around'     => [
                        'title' => esc_html__('Around', 'zenix-essential'),
                        'icon'  => 'eicon-justify-space-around-h',
                    ],                     
                    'space-between'     => [
                        'title' => esc_html__('between', 'zenix-essential'),
                        'icon'  => 'eicon-justify-space-between-h',
                    ],                    
                    'space-evenly'     => [
                        'title' => esc_html__('evenly', 'zenix-essential'),
		...
		$this->add_responsive_control(
			'item_gap',
			[
				'label' => esc_html__( 'Menu Gap', 'zenix-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Offcanvas Content', 'zenix-essential' ),
				'condition' => [
                    'content_source' => 'self',
                ],
			]
			...
			$this->add_control(
				'show_gallery',
				[
					'label'        => esc_html__( 'Show Gallery', 'zenix-essential' ),
					'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'show_socials',
			[
				'label' => esc_html__( 'Show Social Icon', 'zenix-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'zenix-essential' ),
				'label_off' => esc_html__( 'Hide', 'zenix-essential' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Icon Settings', 'zenix-essential' ),
			]
		);	
			...
			$this->add_responsive_control(
				'icon_height',
				[
					'label' => esc_html__( 'Icon Height', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .wdb-default-header-layout ul li' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout ul li a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .wdb-default-header-layout ul li a:hover svg' => 'fill: {{VALUE}}',
					'{{WRAPPER}} .wdb-default-header-layout ul li.active a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .wdb-default-header-layout ul li.active a svg' => 'fill: {{VALUE}}',
				],
			]
		);
		...
		$this->start_controls_tab( 'dnormal',
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a svg' => 'fill: {{VALUE}}',
						'{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a:hover svg' => 'fill: {{VALUE}}',
				],
			]
		);
			...
			$this->start_controls_tabs( 'arrowicon' );
				...
				$this->start_controls_tab( 'arrownormal',
					...
					$this->add_responsive_control(
						'dearrow_iucon_width',
						[
							'label' => esc_html__( 'Svg Width', 'zenix-essential' ),
							'type' => \Elementor\Controls_Manager::SLIDER,
							'size_units' => [ 'px', 'em', 'rem' ],
							'range' => [
								'px' => [
							...
							'selectors' => [
								'{{WRAPPER}} .wdb-default-header-layout ul li a svg' => 'width: {{SIZE}}{{UNIT}};',
							],
						]
					);
				$this->end_controls_tab();
				...
				$this->add_group_control(
					...
					[
						...
						'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a:hover i, {{WRAPPER}} .wdb-default-header-layout ul li a:hover svg',
					]
				);	
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb-default-header-layout' );	
		$this->add_render_attribute( 'wrapper', 'class', $settings['show_offcanvas'] =='yes' ? 'wdb-offcanvas-show' : '' );	
		...
		<button class="wdb-header--offcanvas--icon" data-bs-toggle="offcanvas" data-bs-target="#<?php echo esc_attr($tpl_data['target']); ?>">            
            <?php if($bar !=''){ ?>
