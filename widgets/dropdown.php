...
class Dropdown extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Dropdown / Language ' );
	}

	public function get_icon() {
		return 'wdb eicon-select';
	}
    ...
    public function get_style_depends() {
        wp_register_style( 'wdb-thm-dropdown', ZENIX_ESSENTIAL_ASSETS_URL . 'css/dropdown.css' );
		return [ 'wdb-thm-dropdown' ];
    }
	...
	public function register_content_controls(){
		...
		$repeater->add_control(
			'list_url',
			[
				'label' => esc_html__( 'Url', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '#',
				'label_block' => true,
			]
		...
		$this->add_control(
			'polylang_switcher',
			[
				'label' => esc_html__( 'PolyLang Swicher?', 'zenix-essential' ),
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Dropdown Options', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Title #1', 'zenix-essential' ),						
					],					
				],
	...
	public function register_style_controls(){
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Select', 'zenix-essential' ),
          ...
          <div class="athletic__header-lang">   
              <?php if($settings['polylang_switcher'] == 'yes' && defined( 'POLYLANG_VERSION' )){                
                echo $langs;
                    ...
                    <select id="lang" aria-label="<?php echo esc_attr__('Select Language', 'zenix-essential'); ?>">
