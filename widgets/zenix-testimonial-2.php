 ...
 * @since 1.0.0
 */
class Zenix_Testimonial_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Testimonial 2', 'zenix-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'zenix-testimonial-2', ZENIX_ESSENTIAL_ASSETS_URL . '/js/widgets/zenix-testimonial-2.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'zenix-testimonial-2' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'client_heading',
			[
				'label' => esc_html__( 'Client', 'zenix-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	private function slider_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows and Pagination', 'zenix-essential' ),
					'arrows' => esc_html__( 'Arrows', 'zenix-essential' ),
					'dots'   => esc_html__( 'Pagination', 'zenix-essential' ),
	...
	private function slider_pagination_style_controls() {
		...
		$this->add_control(
			'bar_fill_color',
			[
				'label'     => esc_html__( 'Fill Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'prod_testimonial_thumb ' . $swiper_class,
		...
		$this->add_render_attribute(
			'carousel-wrapper-2',
			[
				'class' => 'prod_testimonial_content ' . $swiper_class,
				'style' => 'position: static',
			]
		);
		?>
        <style>
        .elementor-widget-zenix--testimonial-2 .prod_testimonial_thumb .swiper-slide {
