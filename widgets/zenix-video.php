 ...
 * @since 1.0.0
 */
class Zenix_Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Video', 'zenix-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'zenix-video', ZENIX_ESSENTIAL_ASSETS_URL. '/js/widgets/video.js' , [ 'jquery' ], false, true );
		return [ 'zenix-video' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--video' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
