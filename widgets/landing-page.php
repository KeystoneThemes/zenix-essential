...
class Landing_Page extends Widget_Base {
	...
	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Side Header' );
	}
	...
	public function get_style_depends() {		
		return [ 'zenix-landing-page' ];
	}
	
	public function get_script_depends() {	   
		return [ 'wdb-landing-page' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				'wdbin_se_pg',
				[
					'label' => esc_html__( 'Main Padding', 'zenix-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'CTA Button', 'zenix-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Text Hover Color', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Interface', 'zenix-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'General', 'zenix-essential' ),
			]
		);
			...
			$this->add_responsive_control(
				'mobile_logo_width',
				[
					'label'              => __( 'Mobile Bar Width', 'zenix-essential' ),
			...
			$this->add_responsive_control(
				'containersty_width',
				[
					'label'              => __( 'Main Container Width', 'zenix-essential' ),
					'type'               => Controls_Manager::SLIDER,
					'default'            => [
						'unit' => '%',
					],
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Transparent Menu ?', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Yes', 'zenix-essential' ),
						'relative' => esc_html__( 'No', 'zenix-essential' ),					
			...
			$this->add_control(
				'mobile_bar_direc',
				[
					'label' => esc_html__( 'Bar Direction', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Default', 'zenix-essential' ),
						'row' => esc_html__( 'Row', 'zenix-essential' ),
						'row-reverse'  => esc_html__( 'Row Reverse', 'zenix-essential' ),
						'column' => esc_html__( 'Column', 'zenix-essential' ),
						'column-reverse' => esc_html__( 'Column Reverse', 'zenix-essential' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Mobile Padding', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],					
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function register_content_site_logo_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => 'one',
					'options' => [
						'one'   => esc_html__( 'One' , 'zenix-essential' ),
						'two'       => esc_html__( 'Two' , 'zenix-essential' )		
					],
		...
		$this->start_controls_section(
			'section_site_image',
			[
				'label' => __( 'Menu Settings', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'custom_image',
			[
				'label'     => __( 'Logo / Image', 'zenix-essential' ),
		...
		$this->add_group_control(
			...
			[
				'name'    => 'site_logo_size',
				'label'   => __( 'Image Size', 'zenix-essential' ),
				'default' => 'medium',				
			]
		);
		...
		$this->add_control(
			'menu_list',
			[
				'label' => esc_html__( 'Menu List', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Home', 'zenix-essential' ),						
					],					
				],
		...
		$this->add_control(
			...
			[
				...
				'condition' => ['preset_style' => ['one']],
				'default' => '© Alrights reserved <br> by <a href="https://keystonethemes.com/" target="_blank">Keystone Themes</a>',
		...
		$this->start_controls_section(
			'section_logoimage',
			[
				'label' => __( 'Mobile Interface', 'zenix-essential' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'custom_mobile_image',
				[
					'label'     => __( 'Mobile Logo', 'zenix-essential' ),
					'type'      => Controls_Manager::MEDIA,
					'dynamic'   => [
						'active' => true,
					],
			...
			$this->add_control(
				'custom_bar',
				[
					'label'       => __( 'Custom Mobile Bar', 'zenix-essential' ),
			...
			$this->add_control(
				'bar',
				[
					'label' => esc_html__('Mobile Bar', 'zenix-essential'),
			...
			$this->add_control(
				'custom_bar_image',
				[
					'label' => esc_html__( 'Choose mobile Bar Image', 'zenix-essential' ),
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'close_icon',
				[
					'label' => esc_html__( 'Close Icon', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::ICONS,
					'default' => [					
					]				
				]
		...
		$this->start_controls_section(
			'section_cta_button',
			[
				'label' => __( 'Cta Button', 'zenix-essential' ),
				'condition' => ['preset_style' => ['two']]
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Get Started Now', 'zenix-essential' ),
					'placeholder' => esc_html__( 'Get Started Now', 'zenix-essential' ),
				]
			);
			...
			$this->add_control(
				'show_cta_icon',
				[
					'label' => esc_html__( 'Cta Cta Icon', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'zenix-essential' ),
					'label_off' => esc_html__( 'Hide', 'zenix-essential' ),
					'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_additional',
			[
				'label' => __( 'Additional Settings', 'zenix-essential' ),
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label'              => __( 'Alignment', 'zenix-essential' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => [
					'left'   => [
						'title' => __( 'Left', 'zenix-essential' ),
						'icon'  => 'eicon-text-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'zenix-essential' ),
						'icon'  => 'eicon-text-align-center',
					],
					'right'  => [
						'title' => __( 'Right', 'zenix-essential' ),
		...
		$this->add_control(
			'enable_url_attr',
			[
				'label' => esc_html__( 'Enable Url Attribute', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'mobile_direction',
			[
				'label' => esc_html__( 'Mobile Content Direction', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
	...
	protected function register_site_logo_styling_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Site logo', 'zenix-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Padding', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],				
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'unset' => esc_html__( 'Default', 'zenix-essential' ),
					'100/100' => esc_html__( '100/100', 'zenix-essential' ),			
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'width',
			[
				'label'              => __( 'Width', 'zenix-essential' ),
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control(
			'space',
			[
				'label'              => __( 'Max Width', 'zenix-essential' ) . ' (%)',
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_control(
			'logo_text_color',
			[
				'label'     => __( 'Border Color', 'zenix-essential' ),
		...
		$this->start_controls_tab(
			'normal',
			[
				'label' => __( 'Normal', 'zenix-essential' ),
			]
		);
			...
			$this->add_control(
				'opacity',
				[
					'label'     => __( 'Opacity', 'zenix-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 1,
		...
		$this->start_controls_tab(
			'hover',
			[
				'label' => __( 'Hover', 'zenix-essential' ),
			]
		);
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Transition Duration', 'zenix-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 3,
	...
	protected function register_site_logo_caption_styling_controls() {
		...
		$this->add_control(
			'text_color',
			[
				'label'     => __( 'Text Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'text_active_color',
			[
				'label'     => __( 'Active Border Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Text & Icon Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Typhography', 'zenix-essential' ),
		...
		$this->add_control(
			'text_hover_color',
			[
				'label'     => __( 'Text Hover Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Hover Typhography', 'zenix-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'caption_padding',
			[
				'label'              => __( 'Item Padding', 'zenix-essential' ),
		...
		$this->add_responsive_control(
			'cmenu_wrap_marg',
			[
				'label'              => __( 'Menu Wrapper Margin', 'zenix-essential' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', 'em', '%' ],
				'selectors'          => [
	...
	public function site_image_url( $size ) {
		...
		if ( ! empty( $settings['custom_image']['url'] ) ) {
			...
			$logo            = zenix_option( 'logo', $light_logo ); 				
			return $logo;
		}
	...
	protected function render() {
		...
		if(file_exists(ZENIX_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php')){ 
			include_once(ZENIX_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php'); 
		}	
	}
