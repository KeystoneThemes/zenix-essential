 ...
 * @since 1.0.0
 */
class Zenix_Video_Testimonial extends Widget_Base {
	...
	public function get_name() {
		return 'zenix--video-testimonial';
	}
	...
	public function get_title() {
		return esc_html__( 'Zenix Video Testimonial', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-video-testimonial', ZENIX_ESSENTIAL_ASSETS_URL . 'css/video-testimonial.css' );
		return [ 'zenix-video-testimonial' ];
	}

	public function get_script_depends() {
		wp_register_script( 'zenix-video-testimonial', ZENIX_ESSENTIAL_ASSETS_URL. '/js/widgets/video-testimonial.js' , [ 'jquery' ], false, true );
		return ['swiper', 'magnific-popup', 'zenix-video-testimonial' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Video Testimonial', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'vtm_play_icon',
			[
				'label' => esc_html__( 'Video Play Icon', 'zenix-essential' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label_block'=> true,
				'default' => 'https://keystonethemes.com/dev/video/dancer.mp4',
			]
		);
		...
		$this->start_controls_section(
			'sec_style_vtm_image',
			[
				'label' => esc_html__( 'Video', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'style_vtm_play',
			[
				'label' => esc_html__( 'Play Icon', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'play_wrap_size',
			[
				'label' => esc_html__( 'Wrapper Size', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'zenix_vtm_slider ' . $swiper_class,
