...
<<?php echo esc_attr($settings['header_size']); ?> class="wdb-header-pin-js layout-1 header__area-2 wdb-landing-page-padding <?php echo esc_attr($settings['mobile_direction']); ?> ">
