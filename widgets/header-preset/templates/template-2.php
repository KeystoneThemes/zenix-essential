...
$bar = $settings['bar'];$bar = ZENIX_ESSENTIAL_ASSETS_URL ."images/bars/".$settings['bar'];
...
<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
    <div class="header__inner">
        ...
        <div class="header__logo">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo  esc_attr__('Site Logo', 'zenix-essential'); ?>">
                <?php Group_Control_Image_Size::print_attachment_image_html( $settings, 'thumbnail', 'header_logo' ); ?>
                <?php echo zenix_get_attachment_image_html( $settings, 'thumbnail', 'sticky_logo', ['class' => 'wdb-sticky-logo'] ); ?>
            </a>
            <div class="shape-img">
            ...
            <button class="wdb-header--offcanvas--icon" data-bs-toggle="offcanvas" data-bs-target="#<?php echo esc_attr($tpl_data['target']); ?>" aria-label="<?php echo  esc_attr__('Offcanvas Menu Open Button', 'zenix-essential'); ?>">
		        <?php if($bar !=''){ ?>
                    <img src="<?php echo esc_url($bar); ?>" alt="<?php echo  esc_attr__('Offcanvas Menu Open Icon', 'zenix-essential'); ?>">
                    <?php echo zenix_get_attachment_image_html( $settings, 'thumbnail', 'custom_sticky_bar', ['class' => 'wdb-sticky-bar'] ); ?>
		        <?php }else{ ?>
