...
use ZenixEssentialApp\Inc\WDB_Walker_Elementor_Nav;
...
class Header_Preset extends Widget_Base {
	...
	public function get_title() {
		return wdb_elementor_widget_concat_prefix( 'Header' );
	}
	...
	public function get_all_images_urls($path='bars'){
		$returns_data = [];
		$media_dir = ZENIX_ESSENTIAL_DIR_PATH . "assets/images/{$path}/";
		$url_path = ZENIX_ESSENTIAL_ASSETS_URL ."images/{$path}/";
		try{
	...
	public function get_script_depends() {
	    wp_register_script( 'wdb-header-preset', ZENIX_ESSENTIAL_ASSETS_URL. 'js/widgets/header-preset.js' , [ 'jquery','meanmenu' ], false, true );
		return [ 'wdb-header-preset' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'header_type',
			[
				'label' => esc_html__( 'Header Type', 'zenix-essential' ),
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout' => 'position: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout' => 'top: {{SIZE}}{{UNIT}};',
				],
                'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Hamburger Icon', 'zenix-essential' ),
		...
		$this->add_control(
			'custom_bar',
			[
				'label'       => __( 'Custom Icon', 'zenix-essential' ),
		...
		$this->add_control(
			'bar',
			[
				'label' => esc_html__('Prest Icon', 'zenix-essential'),
				'type' => \ZenixEssentialApp\CustomControl\ImageSelector_Control::ImageSelector,
		...
		$this->add_control(
			'custom_sticky_bar',
			[
				'label' => esc_html__( 'Sticky Header Bar', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
		...
		$this->add_control(
			'header_logo',
			[
				'label' => esc_html__( 'Logo', 'zenix-essential' ),
		...
		$this->add_control(
			'sticky_logo',
			[
				'label' => esc_html__( 'Sticky Header Logo', 'zenix-essential' ),
				'type' => Controls_Manager::MEDIA,				
			]
		);
		...
		$this->add_control(
			'menu_down_icon',
			[
				'label' => esc_html__( 'Nav Down Arrow Icon', 'zenix-essential' ),
		...
		$this->add_control(
			'menu_right_icon',
			[
				'label' => esc_html__( 'Nav Right Arrow Icon', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::ICONS,
				'condition' => ['custom_direction'=>'yes']
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Down Arrow margin', 'zenix-essential' ),
		...
		$this->add_control(
			'icon_cusr_padding',
			[
				'label' => esc_html__( 'Right Arrow margin', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem' ],
				'condition' => ['custom_direction'=>'yes'],
				'selectors' => [
		...
		$this->start_controls_section(
			'section_more_action',
			[
				'label' => esc_html__( 'More Actions', 'zenix-essential' ),
			]
		);
		...
		$action_option = [
			'button' => esc_html__( 'Button', 'zenix-essential' ),
			'search' => esc_html__( 'Search', 'zenix-essential' ),
			'link' => esc_html__( 'Link', 'zenix-essential' ),
		];

		if ( class_exists( 'woocommerce' ) ) { 
			$action_option['cart'] = esc_html__( 'Cart', 'zenix-essential' );
		}

		$repeater_2->add_control(
			'action_type',
			[
				'label' => esc_html__( 'Action Type', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'section_language',
			[
				'label' => esc_html__( 'Language', 'zenix-essential' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Offcanvas Settings', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'max-width',
			[
				'label' => esc_html__( 'Max Width', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'block',
				'options' => [
					'block' => esc_html__( 'Always Show', 'zenix-essential' ),
					'none' => esc_html__( 'Hide', 'zenix-essential' ),
				],
				'selectors' => [
					'{{WRAPPER}} .wdb-header--offcanvas--icon' => 'display: {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'theme',
				'options' => [
					'theme' => esc_html__( 'Theme' , 'zenix-essential' ),
					'self'  => esc_html__( 'Custom' , 'zenix-essential' ),							
				]
		...
		$this->add_control(
			'logo',
			[
				'label' => esc_html__( 'Choose Logo', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::MEDIA,					
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'rows' => 10,
				'default' => esc_html__( 'Default description', 'zenix-essential' ),
		...
		$this->add_control(
			'gal_title',
			[
				'label' => esc_html__( 'Gallery Title', 'zenix-essential' ),
		...
		$this->add_control(
			'social_title',
			[
				'label' => esc_html__( 'Social Title', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Social', 'zenix-essential' ),
				'placeholder' => esc_html__( 'Type your social text here', 'zenix-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'List Item', 'zenix-essential' ),
				'default' => esc_html__( 'List Item', 'zenix-essential' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'social_list',
			[
				'label' => esc_html__( 'Social Items', 'zenix-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),				
				'title_field' => '{{{ title }}}',
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Layout', 'zenix-essential' ),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb-default-header-layout, {{WRAPPER}} .header__lang select, {{WRAPPER}} .info--search, {{WRAPPER}} .wdb--header-5 .header__inner',
			]
		);
		...
		$this->add_responsive_control(
			'layout_item_gap',
			[
				'label' => esc_html__( 'Gap', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'hide_right_border',
			[
				'label' => esc_html__( 'Right Border', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => esc_html__( 'Enable', 'zenix-essential' ),
					'none' => esc_html__( 'Disabled', 'zenix-essential' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'hide_left_border',
			[
				'label' => esc_html__( 'Left Border', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => esc_html__( 'Enable', 'zenix-essential' ),
		...
		$this->add_control(
			'header_heading',
			[
				'label' => esc_html__( 'Header', 'zenix-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'header_border',
				'selector' => '{{WRAPPER}} .wdb-default-header-layout',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Header Container', 'zenix-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'action_items_gap',
			[
				'label' => esc_html__( 'More Actions Gap', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--elementor--menu' => 'justify-content: {{VALUE}};',
				],
		...
		$this->start_controls_tab( 'normal',
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .wdb-default-header-layout ul li a' => 'color: {{VALUE}};fill: {{VALUE}}',
						'{{WRAPPER}} .wdb-default-header-layout ul li' => 'color: {{VALUE}};fill: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a, {{WRAPPER}} .wdb-default-header-layout ul li',
				]
			);	
			...
			$this->add_responsive_control(
				'menu_mpading',
				[
					'label' => esc_html__( 'item Padding', 'zenix-essential' ),
					'type' => \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', 'rem' ],
					'selectors' => [
						'{{WRAPPER}} .wdb-default-header-layout ul > li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					'name' => 'menubackground',
					'types' => [ 'classic', 'gradient'],
					'selector' => '{{WRAPPER}} .wdb-default-header-layout nav > ul',
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout ul li a:hover' => 'color: {{VALUE}};fill: {{VALUE}}',
					'{{WRAPPER}} .wdb-default-header-layout ul li.active a' => 'color: {{VALUE}};fill: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a:hover',
			]
		);	
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown Container', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);	
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .dp-menu' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient'],
				'selector' => '{{WRAPPER}} .wdb-default-header-layout ul.dp-menu',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout ul.dp-menu' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);	
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a' => 'color: {{VALUE}};fill: {{VALUE}}',
                    '{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a, {{WRAPPER}} .wdb-default-header-layout ul.dp-menu li',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wdb-default-header-layout .dp-menu li.menu-item-has-children > a:after' => 'margin-inline-start: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', 'rem' ],
                'selectors' => [
                    '{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout ul.dp-menu li a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Menu Arrow Icon', 'zenix-essential' ),
					'tab'   => Controls_Manager::TAB_STYLE,
				]
			);	
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .wdb-default-header-layout ul li a i' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .wdb-default-header-layout ul li a svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'icon_list_typo',
                'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a i, {{WRAPPER}} .wdb-default-header-layout ul li a svg',
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .wdb-default-header-layout ul li a:hover i' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .wdb-default-header-layout ul li a:hover svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .wdb-default-header-layout ul li a:hover i',
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-header--offcanvas--icon img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'hamburger_size',
			[
				'label' => esc_html__( 'Background Size', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-header--offcanvas--icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-header--offcanvas--icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-header--offcanvas--icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .wdb-header--offcanvas--icon',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .wdb-header--offcanvas--icon:hover',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Offcanvas', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);	
		...
		$this->add_control(
			'offclose_icon_color',
			[
				'label' => esc_html__( 'Close Icon Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_mobile_menu',
			[
				'label' => esc_html__( 'Mobile Menu', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Margin', 'zenix-essential' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_control(
			'mobile_text_color',
			[
				'label' => esc_html__( 'Text Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Menu', 'zenix-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( '3rd Step Sub Menu', 'zenix-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( '2nd Step Icon Position', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function register_button_controls( $repeater_2 ){
		...
		$repeater_2->add_control(
			'btn_text',
			[
				'label' => esc_html__( 'Label', 'zenix-essential' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Type your label', 'zenix-essential' ),
				'default' => esc_html__( 'Button', 'zenix-essential' ),
				'condition' => ['action_type' => 'button'],
			]
		);
        ...
        $repeater_2->add_control(
	        'icon_before',
	        [
		        'label' => esc_html__( 'Icon Before?', 'zenix-essential' ),
		        'type' => Controls_Manager::SWITCHER,
		        'label_on' => esc_html__( 'Yes', 'zenix-essential' ),
		        'label_off' => esc_html__( 'No', 'zenix-essential' ),
		        'return_value' => 'yes',
	...
	protected function register_button_styles(){
		$this->start_controls_section(
			'section_btn_style',
			[
				'label' => esc_html__( 'Button', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'btn_typography',
				'selector' => '{{WRAPPER}} .wdb-default-header-layout .item.button a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'btn_bg',
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .item.button a, {{WRAPPER}} .item.button a:not(.wdb-btn-ellipse), {{WRAPPER}} .item.button a.wdb-btn-mask:after, {{WRAPPER}} .item.button a.wdb-btn-ellipse:before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.button a:hover' => 'border-color: {{VALUE}}',
	...
	protected function register_searchIcon_controls( $repeater_2 ){
		$repeater_2->add_control(
			'search_placeholder',
			[
				'label' => esc_html__( 'Placeholder Text', 'zenix-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Search...', 'zenix-essential' ),
	...
	protected function register_search_styles(){
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'search_switch',
			[
				'label' => esc_html__( 'Show/Hide', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'flex' => esc_html__( 'Show', 'zenix-essential' ),
					'none' => esc_html__( 'Hide', 'zenix-essential' ),
				],
				'selectors' => [
	...
	protected function register_link_styles(){
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb-default-header-layout .item.link a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.link a .icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.link a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.link a:hover' => 'color: {{VALUE}}',
				],
			]
		);
	...
	protected function register_cart_styles(){
		$this->start_controls_section(
			'section_cart_style',
			[
				'label' => esc_html__( 'Cart', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'cart_type',
			[
				'label' => esc_html__( 'Cart Type', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'zenix-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-wc-cart-fragment-content' => 'inset-inline-end: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'cart_type' => 'absolute',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb-default-header-layout .item.cart a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-default-header-layout .item.cart a i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'cart_count_color',
			[
				'label' => esc_html__( 'Count Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .item.cart .wdb-wc-cart-fragment-content' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'cart_count_bg',
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .item.cart .wdb-wc-cart-fragment-content',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .item.cart a:hover .wdb-wc-cart-fragment-content' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .item.cart a:hover .wdb-wc-cart-fragment-content',
			]
		);
	...
	protected function register_language_controls(){
		...
		$this->add_control(
			'language_list',
			[
				'label' => esc_html__( 'Language Options', 'zenix-essential' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_lang->get_controls(),
				'default' => [
					[
						'language' => esc_html__( 'English', 'zenix-essential' ),						
					],					
				],
	...
	protected function render() {		$settings = $this->get_settings_for_display();
		...
		$rapper_attr =[
			'class' => [$preset, 'wdb-default-header-layout'],
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb-offcanvas-show' );
		...
		<style>
			<?php if($settings['sticky_logo']['url'] !=''){ ?>
				...
				.wdb-default-header-layout .wdb-sticky-logo,			
				.wdb-is-sticky .wdb-default-header-layout .header__logo img
				{
				    display: none;
				}				
				.wdb-is-sticky .wdb-default-header-layout .wdb-sticky-logo
				{
			...
			<?php if($settings['custom_sticky_bar']['url'] !=''){ ?>
				.wdb-default-header-layout .wdb-sticky-bar,			
				.wdb-is-sticky .wdb-default-header-layout .wdb-header--offcanvas--icon img			
				{
				    display: none;
				}
				.wdb-is-sticky .wdb-default-header-layout .wdb-sticky-bar				
				{
				    display: block !important;
				}
			<?php } ?>
			.more-actions .item.cart a,.more-actions .style-2,.wdb--header-2 .header__lang select{text-transform:uppercase}.header--search{position:relative}.info--search{position:absolute;width:300px;inset-inline-end:-50px;top:50px;padding:15px 20px;background-color:transparent;border-radius:10px;z-index:9;opacity:0;visibility:hidden;transition:.5s;border:1px solid #fff}.more-actions .style-2,.offcanvas__area,.wdb--header-3 .header__logo,.wdb--header-3 .item,.wdb--header-4 .header__logo,.wdb--header-4 .header__others,.wdb--header-5 .header__inner,.wdb--header-5 .header__logo,.wdb--header-5 .header__others{position:relative}.info--search.visible{opacity:1;visibility:visible;top:40px}.info--search form{display:grid;grid-template-columns:1fr 20px;gap:10px}.info--search input{width:100%;border:0;background:0 0;color:#fff}.info--search input::placeholder{font-size:14px;color:#fff;opacity:.7}.info--search input:focus{outline:0}.info--search .search-icon{width:15px}.search-close{display:none;cursor:pointer}.header__logo{height:100%;min-width:80px;display:flex;align-items:center}.more-actions .item,.more-actions .item.cart a,.wdb-default-header-layout .btn-wrap{align-items:center;display:flex}.header__logo img{min-width:60px}.wdb-header--offcanvas--icon img{min-width:auto}.wdb-header--offcanvas--icon{transition:.3s;min-width:30px}.more-actions .style-2{color:#1c1d20;background:#ffc700;border:3px solid #1c1d20;border-radius:25px;padding:12px 20px;box-shadow:5px 5px}.more-actions .style-2:hover{box-shadow:none}.wdb-wc-cart-fragment-content{background:#e8bf96;width:20px;height:20px;border-radius:100%;line-height:20px;text-align:center;color:#fff;font-size:11px;transition:.3s}.more-actions{display:flex}.more-actions .item.cart a{gap:10px;padding:14px 20px;border:1px solid #1c1d20;border-radius:25px;font-weight:400;font-size:22px;line-height:22px;color:#1c1d20}.wdb--header-1 .search-close,.wdb--header-1 .search-icon,.wdb-default-header-layout .item.link a{fill:#202C58;color:#202c58;transition:.3s}.wdb-default-header-layout .item.link a{gap:15px;display:flex;align-items:center;text-align:right;font-size:14px;font-weight:500;line-height:1.5;text-transform:uppercase}.wdb-default-header-layout .item.link a:hover{color:#e8bf96;fill:#E8BF96}.wdb-default-header-layout{padding:20px 100px;width:100%;left:0;top:0;z-index:99}.wdb--header-2,.wdb--header-3{padding:0 100px}.offcanvas__area{z-index:9999}.wdb--header-1 i,.wdb--header-1 svg{width:1em;height:1em}.wdb--header-1 .header__inner{gap:30px;display:grid;align-items:center;grid-template-columns:1fr 2.5fr 1fr}.wdb--header-1 .header__logo img{object-fit:cover}.wdb--header-1 .header__others{gap:20px;display:flex;height:100%;align-items:center;justify-content:flex-end}.wdb--header-1 .more-actions{gap:20px;display:flex}.wdb--header-1 .item.link a span{text-align:right}.wdb--header-1 .item.link a .icon{font-size:20px}.wdb--header-1 .header__lang select,.wdb--header-2 .header__lang select{background:0 0;border:none;border-radius:0;padding:10px}.elementor-widget-wdb--header-preset.info--menu-alignment-end .header__inner,.elementor-widget-wdb--header-preset.info--menu-alignment-start .header__inner{grid-template-columns:auto 1fr auto}.elementor-widget-wdb--header-preset.info--menu-alignment-end .header__inner.wdb-mobile-nav-active,.elementor-widget-wdb--header-preset.info--menu-alignment-start .header__inner.wdb-mobile-nav-active{display:flex;align-items:center;justify-content:space-between}.elementor-widget-wdb--header-preset.info--menu-alignment-center .header__inner{grid-template-columns:1fr 2.5fr 1fr}.elementor-widget-wdb--header-preset.info--menu-alignment-center .header__inner.wdb-mobile-nav-active{display:flex;align-items:center;justify-content:space-between}.header__inner.wdb-mobile-nav-active .header__nav,.wdb--header-3 .item:last-child::after{display:none}.wdb--header-2 .header__inner{display:grid;border-bottom:1px solid #1c1d20}.wdb--header-2 .header__logo,.wdb--header-2 .header__others{gap:30px;display:flex;align-items:center;position:relative}.wdb--header-2 .item.cart a:hover{color:#f0b849;border-color:#f0b849}.wdb--header-2 .wdb-wc-cart-fragment-content{background:var(--orange-2)}.wdb--header-2 .main-menu>ul>li>a{color:#2c3034;padding:30px 15px}.wdb--header-2 .main-menu>ul>li>a:hover{color:#f0b849}.wdb--header-3{border-bottom:1px solid #e4ddd5}.wdb--header-3 .info--search{background-color:#fbf8f3}.wdb--header-3 .info--search input,.wdb--header-3 .info--search input::placeholder{color:#555}.wdb--header-3 .main-menu>ul>li>a{color:#555}.wdb--header-4 .main-menu>ul>li>a,.wdb--header-5 .main-menu>ul>li>a{color:#1c1d20}.wdb--header-3 .header__logo{gap:50px}.wdb--header-3 .line{width:1px;background-color:#e4ddd5}.wdb--header-3 .item.button a{color:#fff;padding:13px 36px;background-color:#6a6bbf}.wdb--header-3 .header__logo::after{position:absolute;content:"";width:1px;height:100%;inset-inline-end:calc(var(--gap,-50px)/ 2);top:0;background-color:#e4ddd5}.wdb--header-3 .wdb-separator::after{position:absolute;content:"";top:0;inset-inline-end:calc(var(--gap,-20px)/ 2);width:1px;height:100%;background-color:#e4ddd5}.wdb--header-4 .header__logo::after,.wdb--header-4 .header__others::before{position:absolute;content:"";width:1px;height:100%;top:0;background-color:#e7cfbe}.wdb--header-4{padding:0 150px}.wdb--header-4 .header__inner{gap:100px;border-bottom:1px solid #e7cfbe}.wdb--header-4 .header__logo::after{inset-inline-end:calc(var(--gap,-100px)/ 2)}.wdb--header-4 .header__others::before{inset-inline-start:calc(var(--gap,-100px)/ 2)}.wdb--header-5 .header__logo::after,.wdb--header-5 .header__others::before{position:absolute;content:"";width:3px;height:100%;top:0;background-color:#1c1d20}.wdb--header-5{padding:0}.wdb--header-5 .header__inner{padding:0 30px;background-color:#fff;border:3px solid var(--black-2);border-top:none;border-bottom-width:10px;border-radius:0 0 45px 45px;gap:80px}.wdb--header-5 .header__logo::after{inset-inline-end:calc(var(--gap,-80px)/ 2)}.wdb--header-5 .header__others::before{inset-inline-start:calc(var(--gap,-80px)/ 2)}.elementor-widget-wdb--header-preset.info--menu-alignment-center .wdb--header-5 .header__inner{grid-template-columns:1fr 4fr 1fr}.elementor-widget-wdb--header-preset.info--menu-alignment-center .wdb--header-5 .header__inner.wdb-mobile-nav-active{display:flex;align-items:center;justify-content:space-between}@media (max-width:1399px){.wdb-default-header-layout{padding:20px 50px}}@media (max-width:1199px){.wdb-default-header-layout{padding:15px 30px}}@media (max-width:991px){.wdb-default-header-layout{padding:15px 30px}}@media (max-width:767px){.wdb-default-header-layout{padding:15px}.wdb--header-2 .header__logo{justify-content:space-between;width:100%}.info--search{inset-inline-end:-120px}}
		</style>
		<?php
                        ...
                        <div class="offcanvas__body">
                            <div class="offcanvas__logo">
                                <?php if(isset( $settings['logo']['url'] ) && $settings['logo']['url'] !=''): ?>
                                    <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url($settings['logo']['url']); ?>" alt="<?php echo esc_attr__('Offcanvas Logo','zenix-essential') ?>"></a>
                                <?php endif; ?>
                                <div class="desc">
	...
	protected function render_wc_cart( $item, $key ) {
        ...
        <div class="header-cart">
            <a <?php $this->print_render_attribute_string( 'cart_link'.$key ); ?>>
                ...
                <div class="wdb-text d-inline"><?php echo $item[ 'cart_text' ] ?></div>
    ...
    protected function render_button( $item, $key, $settings ) {
        ...
        <a <?php $this->print_render_attribute_string( 'btn_link' ); ?>
                class="wdb-btn-default btn-<?php echo $item['btn_hover_list']; ?>">
	...
	protected function render_search( $item, $key ) {
        ...
        <div class="header--search">
            ...
            <button class="search-close"><i class="wdb-icon icon-wdb-close"></i></button>
