...
class Zenix_Gallery extends Widget_Base {

	public function get_name() {
		return 'zenix--gallery';
	}

	public function get_title() {
		return esc_html__( 'Zenix Gallery', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-gallery', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-gallery.css' );

		return [ 'zenix-gallery' ];
	}

	public function get_script_depends() {
		wp_register_script( 'zenix-gallery', ZENIX_ESSENTIAL_ASSETS_URL . '/js/widgets/zenix-gallery.js', [ 'jquery' ], false, true );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_gallery',
			[
				'label' => __( 'Gallery', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Case Study', 'zenix-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'g_title_tag',
			[
				'label'   => esc_html__( 'HTML Tag', 'zenix-essential' ),
	...
	protected function gallery_slider_one_controls() {
		$this->start_controls_section(
			'sec_g_slider',
			[
				'label' => __( 'Gallery Slider One', 'zenix-essential' ),
			]
		);
		...
		$g_slider->add_control(
			'gs_source',
			[
				'label'   => esc_html__( 'Type', 'zenix-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'image',
				'options' => [
					'image' => esc_html__( 'Image', 'zenix-essential' ),
					'video' => esc_html__( 'Video', 'zenix-essential' ),
				],
			]
		);
		...
		$g_slider->add_control(
			'gs_image',
			[
				'label'   => esc_html__( 'Choose Image', 'zenix-essential' ),
		...
		$g_slider->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => 'https://keystonethemes.com/assets/wp-content/uploads/2024/05/insurance-video.mp4',
				'condition'   => [
					'gs_source' => 'video',
				],
				'ai'          => [
		...
		$g_slider->add_control(
			...
			[
				'label'       => esc_html__( 'Title', 'zenix-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Mastartery', 'zenix-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$g_slider->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Design - 2019', 'zenix-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'gs_items',
			[
				'label'       => esc_html__( 'Gallery Slider Items', 'zenix-essential' ),
		...
		$this->add_control(
			'gs_title_tag',
			[
				'label'   => esc_html__( 'Title HTML Tag', 'zenix-essential' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'h1'   => 'H1',
					'h2'   => 'H2',
	...
	protected function gallery_slider_two_controls() {
		$this->start_controls_section(
			'sec_g_slider_2',
			[
				'label' => __( 'Gallery Slider Two', 'zenix-essential' ),
			]
		);
	...
	public function register_style_controls() {
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label' => esc_html__( 'Gallery', 'zenix-essential' ),
		...
		$this->add_responsive_control(
			'img_vdo_height',
			[
				'label' => esc_html__( 'Image/Video Height', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'separator' => 'before',
				'range' => [
		...
		$this->start_controls_section(
			'sec_style_circle',
			[
				'label' => esc_html__( 'Circle', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'progress_size',
			[
				'label' => esc_html__( 'Progress Size', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
        ...
        <div class="g-slider--two-wrap" dir="rtl">
            <div class="g-slider--two">
		        ...
		        $gs_link_2 = 'gs_link_' . $index;

		        if ( ! empty( $item['gs_link_2']['url'] ) ) {
			        $this->add_link_attributes( $gs_link_2, $item['gs_link_2'] );
		        }
		        ?>
                <a class="item" <?php $this->print_render_attribute_string( $gs_link_2 ); ?>>
                    <div class="source">
