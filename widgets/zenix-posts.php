...
class Zenix_Posts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Posts', 'zenix-essential' );
	}

	public function get_icon() {
		return 'wdb eicon-post-list';
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-button', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-button.css' );
		wp_register_style( 'zenix-posts', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-post.css' );

		return [ 'zenix-button', 'zenix-posts' ];
	}

	// Content Control
	public function register_content_controls() {
		$this->start_controls_section(
			'zenix_sec_post_layout',
			[
				'label' => __( 'Layout', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'after',
				'options'   => [
					'1' => esc_html__( 'One', 'zenix-essential' ),
					'2' => esc_html__( 'Two', 'zenix-essential' ),
					'3' => esc_html__( 'Three', 'zenix-essential' ),
					'4' => esc_html__( 'Four', 'zenix-essential' ),
					'5' => esc_html__( 'Five', 'zenix-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'btn_text',
			[
				'label'       => esc_html__( 'Read More Text', 'zenix-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Read More', 'zenix-essential' ),
				'placeholder' => esc_html__( 'Type your text here', 'zenix-essential' ),
				'condition'   => [
					'element_list' => ['2', '4'],
				],
			]
		...
		$this->add_control(
			'btn_icon',
			[
				'label'       => esc_html__( 'Read More Icon', 'zenix-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'       => esc_html__( 'Date Text', 'zenix-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Written by', 'zenix-essential' ),
				'placeholder' => esc_html__( 'Type your text here', 'zenix-essential' ),
				'condition'   => [
					'element_list' => '2',
				],
		...
		$this->add_control(
			'link_icon',
			[
				'label'       => esc_html__( 'Link Icon', 'zenix-essential' ),
				'type'        => Controls_Manager::ICONS,
				'skin'        => 'inline',
				'label_block' => false,
				'default'     => [
		...
		$this->add_control(
			'zenix_show_title',
			[
				'label'     => esc_html__( 'Show Title', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'zenix_show_excerpt',
			[
				'label'     => esc_html__( 'Show Excerpt', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_thumb',
			[
				'label'     => esc_html__( 'Show Thumbnail', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'no',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_meta',
			[
				'label'     => esc_html__( 'Show Meta', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_author',
			[
				'label'     => esc_html__( 'Show Author', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_date',
			[
				'label'     => esc_html__( 'Show Date', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_category',
			[
				'label'     => esc_html__( 'Show Category', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_comment',
			[
				'label'     => esc_html__( 'Show Comment', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_rm',
			[
				'label'     => esc_html__( 'Show Read More', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_show_link',
			[
				'label'     => esc_html__( 'Show Link Icon', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'zenix-essential' ),
				'label_on'  => esc_html__( 'On', 'zenix-essential' ),
		...
		// Query
		$this->start_controls_section(
			'zenix_sec_post_query',
			[
				'label' => __( 'Query', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'query_type',
			[
				'label'   => esc_html__( 'Query Type', 'zenix-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'post',
				'options' => [
					'post'    => esc_html__( 'Posts', 'zenix-essential' ),
					'archive' => esc_html__( 'Archive', 'zenix-essential' ),
					'related' => esc_html__( 'related', 'zenix-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'posts_id',
			[
				'label'       => esc_html__( 'Include Posts', 'zenix-essential' ),
		...
		$this->add_control(
			'zenix_post_order_by',
			[
				'label'     => esc_html__( 'Order By', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'date',
				'options'   => [
					'date'          => esc_html__( 'Date', 'zenix-essential' ),
					'title'         => esc_html__( 'Title', 'zenix-essential' ),
					'menu_order'    => esc_html__( 'Menu Order', 'zenix-essential' ),
					'modified'      => esc_html__( 'Last Modified', 'zenix-essential' ),
					'comment_count' => esc_html__( 'Comment Count', 'zenix-essential' ),
					'rand'          => esc_html__( 'Random', 'zenix-essential' ),
				],
				'condition' => [
		...
		$this->add_control(
			'zenix_post_order',
			[
				'label'     => esc_html__( 'Order', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'desc',
				'options'   => [
					'asc'  => esc_html__( 'ASC', 'zenix-essential' ),
					'desc' => esc_html__( 'DESC', 'zenix-essential' ),
				],
				'condition' => [
					'query_type' => [ 'post', 'related' ],
				],
		...
		$this->add_control(
			'zenix_posts_ppage',
			[
				'label'     => esc_html__( 'Posts Per Page', 'zenix-essential' ),
	...
	public function register_style_controls() {
		...
		$this->add_responsive_control(
			'blog_cols',
			[
				'label'     => esc_html__( 'Columns', 'zenix-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
				...
				'selectors' => [
					'{{WRAPPER}} .zenix--post' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_col_gap',
			[
				'label'      => esc_html__( 'Column Gap', 'zenix-essential' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--post' => 'column-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_row_gap',
			[
				'label'      => esc_html__( 'Row Gap', 'zenix-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--post' => 'row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_item_gap',
			[
				'label'      => esc_html__( 'Item Inner Gap', 'zenix-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .item' => 'gap: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .zenix--post .item',
                'condition' => ['element_list' => '4'],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'blog_h_border_color',
			[
				'label'     => esc_html__( 'Border Hover Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zenix--post .item:hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'element_list' => '1',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label'     => esc_html__( 'Item', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '5'],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .wrapper' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'element_list' =>  '5',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zenix--post.post-style-3 .item::after, {{WRAPPER}} .zenix--post .wrapper' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .zenix--post .wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_thumb',
			[
				'label'     => esc_html__( 'Thumbnail', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_thumb' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'zenix_style_excerpt',
			[
				'label'     => esc_html__( 'Excerpt', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_excerpt' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_meta',
			[
				'label'     => esc_html__( 'Meta', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_meta' => 'yes',
				],
		...
		$this->add_control(
			'separator_color',
			[
				'label'     => esc_html__( 'Separator Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'sec_style_author',
			[
				'label'     => esc_html__( 'Author', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_author' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Image', 'zenix-essential' ),
		...
		$this->add_control(
			'author_name_heading',
			[
				'label'     => esc_html__( 'Name', 'zenix-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'element_list' => '2',
		...
		$this->start_controls_section(
			'sec_style_category',
			[
				'label'     => esc_html__( 'Category', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_category' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'style_read_more',
			[
				'label'     => esc_html__( 'Read More', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'zenix_show_rm' => 'yes',
					'element_list'   => ['2', '4'],
		...
		$this->add_responsive_control(
			'btn_icon_width',
			[
				'label'     => esc_html__( 'Icon Width', 'zenix-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
		...
		$this->start_controls_section(
			'sec_style_number',
			[
				'label'     => esc_html__( 'Number', 'zenix-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => '1',
				],
	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'numbers_and_prev_next' => esc_html__( 'Numbers', 'zenix-essential' ) . ' + ' . esc_html__( 'Previous/Next', 'zenix-essential' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Page Limit', 'zenix-essential' ),
				'default'   => '5',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Shorten', 'zenix-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'pagination_type' => 'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Colors', 'zenix-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function query_arg() {
		...
		if ( 'related' === $this->get_settings( 'query_type' ) && is_singular() ) {
			...
			$query_args['posts_per_page'] = $this->get_settings( 'zenix_posts_ppage' );
		...
		$query_args = [
			'post_type'      => 'post',
			'posts_per_page' => $this->get_settings( 'zenix_posts_ppage' ),
			'paged'          => $this->get_current_page(),
			'order'          => $this->get_settings( 'zenix_post_order' ),
			'orderby'        => $this->get_settings( 'zenix_post_order_by' ),
	...
	protected function render() {
		...
		$zenix_query = $this->get_query();

		?>
        <div class="zenix--post post-style-<?php echo $settings['element_list']; ?>">
			<?php
			$post_count = 1;
			while ( $zenix_query->have_posts() ) {
				$zenix_query->the_post();
		...
		<?php
		$this->render_pagination( $zenix_query );
		wp_reset_postdata();
	}
	...
	protected function render_pagination( $query ) {
		...
		if ( 'numbers_and_prev_next' === $settings['pagination_type'] ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . esc_html__( 'Page', 'zenix-essential' ) . '</span>',
			];
            ...
            <nav <?php $this->print_render_attribute_string( 'pagination' ); ?>
                    aria-label="<?php esc_attr_e( 'Pagination', 'zenix-essential' ); ?>" style="display: flex">
	...
	private function render_post_1( $settings, $post_count ) {
        ...
        <article <?php post_class( 'item' ); ?>>
			<?php
			if ( 'yes' === $settings['zenix_show_thumb'] ) {
				?>
                <div class="thumb">
            ...
            <div class="wrapper">
                <div class="number"><?php if ( $post_count < 9 ) {
						echo esc_html__('0', 'zenix-essential');
					}
					echo $post_count; ?></div>
                <div class="content">
					<?php
					$post_meta = [];
					$category  = zenix_get_random_category();

					if ( 'yes' === $settings['zenix_show_author'] ) {
					...
					if ( 'yes' === $settings['zenix_show_category'] ) {
						$post_meta[] = $category;
					}

					if ( 'yes' === $settings['zenix_show_date'] ) {
						$post_meta[] = get_the_date( get_option( 'date_format' ) );
					}

					if ( 'yes' === $settings['zenix_show_comment'] ) {
						$comments_number = get_comments_number();
						$post_meta[]     = $comments_number > 1 ? sprintf( esc_html__( '%s comments', 'zenix' ), $comments_number ) : sprintf( esc_html__( '%s comment', 'zenix' ), $comments_number );
					}
					?>
					<?php if ( 'yes' === $settings['zenix_show_meta'] ) { ?>
                        <div class="post-meta">
							<?php
							echo zenix_kses( implode( '<span></span>', $post_meta ) );
							?>
                        </div>
					<?php } ?>

					<?php
					if ( 'yes' === $settings['zenix_show_title'] ) {
						?>
                        <h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						<?php
					}

					if ( 'yes' === $settings['zenix_show_excerpt'] ) {
						?>
                        <div class="cf_text">
							<?php zenix_excerpt( 40, null ); ?>
                        </div>
						<?php
					}
					?>
				...
				<?php
				if ( 'yes' === $settings['zenix_show_link'] ) {
					?>
                    <div class="link-wrap">
                        ...
                        <div class="wc-btn-wrapper style-<?php echo esc_html( $settings['btn_style'] ); ?>">
                            <a href="<?php the_permalink(); ?>" class="wc-btn-group">
                                ...
                                <span class="wc-btn-primary">
                                    <div class="screen-reader-text"><?php echo esc_html__('Read Post Details', 'zenix-essential'); ?></div>
...
//		                $post_meta[] = get_the_date( get_option( 'date_format' ) );
	                ...
	                if ( 'yes' === $settings['zenix_show_comment'] ) {
		                $comments_number = get_comments_number();
		                $post_meta[]     = $comments_number > 1 ? sprintf( "<div class='pmeta'>" . esc_html__( '%s comments', 'zenix' ), $comments_number ) ."</div>" : sprintf( "<div class='pmeta'>" . esc_html__( '%s comment', 'zenix' ), $comments_number ) ."</div>";
	                }
	                ?>
	                <?php if ( 'yes' === $settings['zenix_show_meta'] ) { ?>
                        <div class="post-meta">
