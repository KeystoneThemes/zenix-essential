...
class Zenix_Service extends Widget_Base {

	public function get_name() {
		return 'zenix--service';
	}

	public function get_title() {
		return esc_html__( 'Zenix Service', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix-service', ZENIX_ESSENTIAL_ASSETS_URL . 'css/zenix-service.css' );
	...
	public function register_content_controls() {
		$this->start_controls_section(
			'sec_content',
			[
				'label' => __( 'Service', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Service Title', 'zenix-essential' ),
                'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => esc_html__( 'we approach each project with meticulous attention to detail and best quality.', 'zenix-essential' ),
			]
		);
	...
	public function register_style_controls() {
		...
		$this->add_control(
			'num_h_color',
			[
				'label' => esc_html__( 'Number Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'title_h_color',
			[
				'label' => esc_html__( 'Title Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'desc_h_color',
			[
				'label' => esc_html__( 'Desc Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'overlay_color',
			[
				'label' => esc_html__( 'Overlay Color', 'zenix-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'overlay_opacity',
			[
				'label' => esc_html__( 'Opacity', 'zenix-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        <div class="a-service--item style-<?php echo esc_html( $settings['service_style'] ); ?>">
            ...
            <div class="btn-wrapper">
		        <?php if ( '1' === $settings['service_style'] ): ?>
                    <a <?php $this->print_render_attribute_string( 'btn_link' ); ?> class="a-btn-circle" aria-label="<?php echo esc_attr__('Read Service Details', 'zenix-essential'); ?>">
