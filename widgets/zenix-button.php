...
class Zenix_Button extends Widget_Base {

	public function get_name() {
		return 'wdb--zenix-button';
	}

	public function get_title() {
		return esc_html__( 'Zenix Button', 'zenix-essential' );
	}
	...
	public function register_content_controls() {
		...
		$this->add_control(
			'btn_shape',
			[
				'label' => esc_html__( 'Choose Shape', 'zenix-essential' ),
		...
		$this->add_control(
			'btn_width',
			[
				'label' => esc_html__( 'Button Width', 'zenix-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'prefix_class' => 'zenix-btn-width-',
				'options' => [
					'' => esc_html__( 'Default', 'zenix-essential' ),
					'full' => esc_html__( 'Full Width', 'zenix-essential' ),
				],
				'condition' => [
					'btn_style' => ['3', '4'],
				],
	...
	public function register_style_controls() {
		...
		$this->add_control(
			'btn_crop_b_color_1',
			[
				'label'     => esc_html__( 'Border Color One', 'zenix-essential' ),
		...
		$this->add_control(
			'btn_crop_b_color_2',
			[
				'label'     => esc_html__( 'Border Color Two', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_3',
			[
				'label'     => esc_html__( 'Border Color Three', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_4',
			[
				'label'     => esc_html__( 'Border Color Four', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
