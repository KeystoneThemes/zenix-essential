        ...
        <?php if(!empty($settings['follow_info'])){ ?>
          <div class="offcanvas-4__social d-none d-md-flex">
            <div class="offcanvas-4__social-links offcanvas__social__links">
              ...
              ?>
                <a class="elementor-repeater-item-<?php echo esc_attr( $fol['_id'] ); ?>" <?php echo $this->get_render_attribute_string( 'follow_me_link' ); ?>><?php echo \ZenixEssentialApp\Inc\Iinherit\Wdb_Icon_Manager::render_icon( $fol['icon'] , [ 'aria-hidden' => 'true' ] ); ?></a>
              <?php } ?>              
            </div>
