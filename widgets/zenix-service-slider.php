 ...
 * @since 1.0.0
 */
class Zenix_Service_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Zenix Service Slider', 'zenix-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'zenix--service-slider', ZENIX_ESSENTIAL_ASSETS_URL . 'css/service-slider.css' );

		return [ 'zenix--service-slider' ];
	}

	public function get_script_depends() {
		wp_register_script( 'zenix--service-slider', ZENIX_ESSENTIAL_ASSETS_URL . '/js/widgets/service-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'zenix--service-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_bss_content',
			[
				'label' => esc_html__( 'Service', 'zenix-essential' ),
			]
		);
		...
		$this->add_control(
			'bss_sec_title',
			[
				'label'       => esc_html__( 'Section Title', 'zenix-essential' ),
		...
		$repeater->add_control(
			'bss_btn_link',
			[
				'label'       => esc_html__( 'Button Link', 'zenix-essential' ),
		...
		$this->add_control(
			'bss_list',
			[
				'label'   => esc_html__( 'Services', 'zenix-essential' ),
	...
	private function slider_controls() {
		...
		$this->add_control(
			'mousewheel',
			[
				'label'       => esc_html__( 'Mousewheel', 'zenix-essential' ),
				'description' => esc_html__( 'If you want to use mousewheel, please disable loop.', 'zenix-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows & Fraction', 'zenix-essential' ),
					'arrows' => esc_html__( 'Arrows', 'zenix-essential' ),
					'dots'   => esc_html__( 'Fraction', 'zenix-essential' ),
	...
	public function register_style_btn_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Icon', 'zenix-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'btn_icon_width',
			[
				'label'     => esc_html__( 'Circle Width', 'zenix-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-arrow' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-arrow:hover' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'zenix_service_slider ' . $swiper_class,
