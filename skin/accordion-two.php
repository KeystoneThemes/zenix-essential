...
namespace ZenixEssentialApp\Skin\Accordion;
...
class Skin_Accordion_Two extends Skin_Base {
	...
	public function get_title() {
		return __( 'WDB Style Two', 'zenix-essential' );
	}
	...
	public function inner_title_style_control( $element ) {
		$element->start_controls_section(
			'wdb_stitleicon2_section',
			[
				'label'     => esc_html__( 'Title Icon', 'zenix-essential' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => 'skin-wdb-accordion-two',
				],
			]
		);

		$element->add_responsive_control(
			'wdb_title2_icon_space',
			[
		...
		$element->add_group_control(
			...
			[
				'name'     => 'wdb_title2_icon_typography',
	...
	public function inner_content_style_control( $element ) {
		...
		$element->start_controls_section(
			'wdb_styleicon2_section',
			[
				'label'     => esc_html__( 'Inner Content', 'zenix-essential' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => 'skin-wdb-accordion-two',
				],
		...
		$element->start_controls_tabs(
			'wdb_icont2_style_tabs'
		);

		$element->start_controls_tab(
			'wdb_icont2_style_icon_tab',
			[
		...
		$element->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb--inner--accrodion--body i'        => 'color: {{VALUE}}',
					'{{WRAPPER}} .wdb--inner--accrodion--body svg'      => 'fill: {{VALUE}}',
					'{{WRAPPER}} .wdb--inner--accrodion--body svg path' => 'fill: {{VALUE}}',
				],
			]
		);
		...
		$element->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name'     => 'wdb_ci2_typography',
				'selector' => '{{WRAPPER}} .wdb--inner--accrodion--body i',
			]
		);
		...
		$element->add_responsive_control(
			'wdb_inner2_space',
			[
				'label'     => esc_html__( 'Icon Spacing', 'zenix-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--inner--accrodion--body' => 'gap: {{SIZE}}{{UNIT}};',
		...
		$element->add_control(
			'wdb_inner2_padding',
			[
				'label'      => esc_html__( 'Content Padding', 'zenix-essential' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--inner--accrodion--body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public function content_style_control( $element ) {
		...
		$element->add_responsive_control(
			'wdb_content2__margin',
			[
				'label'      => esc_html__( 'Margin', 'zenix-essential' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--inner--accrodion--body' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public function title_style_control( $element ) {
		...
		$element->add_control(
			...
			[
				...
				'options'   => [
					'left'  => [
						'title' => esc_html__( 'Start', 'zenix-essential' ),
						'icon'  => 'eicon-h-align-left',
					],
					'right' => [
						'title' => esc_html__( 'End', 'zenix-essential' ),
	...
	public function title_number_style( $element ) {
		$element->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Number & Line', 'zenix-essential' ),
		...
		$element->add_control(
			'line_bar_color',
			[
				'label'     => esc_html__( 'Line Color', 'zenix-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb--accordion-two .elementor-tab-content::after, {{WRAPPER}} .wdb--accordion-two .elementor-accordion-title::after' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$element->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--accordion-two .elementor-accordion-title::after' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$element->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--accordion-two .elementor-tab-content::after, {{WRAPPER}} .wdb--accordion-two .elementor-accordion-title::after' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$element->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--accordion-two .elementor-tab-content::after, {{WRAPPER}} .wdb--accordion-two .elementor-accordion-title::after' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$element->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--accordion-two .elementor-tab-content::after' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	public function new_feature_controls( $element ) {
		...
		$element->start_controls_section(
			'wdb2_settings',
			[
				'label'     => esc_html__( 'WDB General', 'zenix-essential' ),
				'condition' => [
					'_skin' => 'skin-wdb-accordion-two',
				],
			]
		...
		$element->add_control(
			'default2_active',
			[
				'label'        => esc_html__( 'Default Active', 'zenix-essential' ),
		...
		$element->add_control(
			'title2_icon_after',
			[
				'label'        => esc_html__( 'Title Icon After Title', 'zenix-essential' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'zenix-essential' ),
				'label_off'    => esc_html__( 'No', 'zenix-essential' ),
				'return_value' => 'yes',
		...
		$element->add_control(
			'innericon2_align',
			[
				'label'     => esc_html__( 'Content Alignment', 'zenix-essential' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row'         => [
						'title' => esc_html__( 'Start', 'zenix-essential' ),
				...
				'toggle'    => false,
				'selectors' => [
					'{{WRAPPER}} .wdb--inner--accrodion--body' => 'flex-direction: {{VALUE}};',
				],
			]
		);
	...
	public function update_controls( $element ) {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( '01', 'zenix-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'Accordion Title', 'zenix-essential' ),
				'dynamic'     => [
					'active' => true,
				],
				'label_block' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accordion Content', 'zenix-essential' ),
			]
		);
		...
		$repeater->add_control(
			'wdb_content_icon',
			[
				'label' => esc_html__( 'Content Icon', 'zenix-essential' ),
				'type'  => \Elementor\Controls_Manager::ICONS,
			]
		);

		$repeater->add_control(
			'wdb_accordion_reapeater_hidden_id',
			[
	...
	public function render() {
		...
		$this->parent->add_render_attribute(
			...
			[
				...
				'class'       => [ 'elementor-accordion', 'wdb--accordion-two' ],
		...
		?>
        <style>
            .wdb--accordion-two .elementor-accordion-title {
                display: flex;
                align-items: center;
            }
            .wdb--accordion-two .elementor-accordion-title::after {
                position: absolute;
                content: "";
                width: 1px;
                height: 20px;
            ...
            .wdb--accordion-two .elementor-tab-title {
                padding: 30px 0;
            }
            .wdb--accordion-two .elementor-accordion-item {
                border: none;
                border-bottom: 1px solid #ddd;
                position: relative;
            }
            .wdb--accordion-two .elementor-tab-content {
                border: none;
            }
            .wdb--accordion-two .elementor-tab-content::after {
                position: absolute;
                content: "";
                width: 1px;
                height: 65%;
        ...
        <div <?php echo $this->parent->get_render_attribute_string( 'wdb_wrapper' ); ?>>
			<?php
            ...
            <div class="elementor-accordion-item">
                ...
                <div class="elementor-accordion-title" tabindex="0">
					<?php if ( $settings['title_icon_after'] === '' ) { ?>
                        <span class="elementor-accordion-title-icon"><?php \Elementor\Icons_Manager::render_icon( $item['wdb_title_icon'] ); ?></span>
					<?php } ?>
					<?php
            ...
            <div <?php $this->parent->print_render_attribute_string( $tab_content_setting_key ); ?>>
                <div class="wdb--inner--accrodion--body">
					<?php if ( isset( $item['wdb_content_icon']['value'] ) && $item['wdb_content_icon']['value'] != '' ) { ?>
                        <span class="wdb-content-icon">
									<?php \Elementor\Icons_Manager::render_icon( $item['wdb_content_icon'] ); ?>
								</span>
					<?php } ?>
                    <div class="wdb--content"><?php echo $item['tab_content']; ?></div>
                </div>
            </div>
        </div>
	<?php endforeach; ?>
