...
class Skin_Accordion extends Skin_Base {
	...
	public function get_title() {
		return __( 'Zenix', 'zenix-essential' );
	}
	...
	public function inner_title_style_control( $element ) {
		$element->start_controls_section(
			'wdb_stitleicon_section',
			[
				'label'     => esc_html__( 'Title Icon', 'zenix-essential' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => 'skin-wdb-accordion',
				],
			]
		);

		$element->add_responsive_control(
			'wdb_title_icon_space',
			[
		...
		$element->add_group_control(
			...
			[
				'name'     => 'wdb_title_icon_typography',
	...
	public function inner_content_style_control( $element ) {
		...
		$element->start_controls_tabs(
			'wdb_icont_style_tabs'
		);

		$element->start_controls_tab(
			'wdb_icont_style_icon_tab',
			[
	...
	public function new_feature_controls( $element ) {
		...
		$element->start_controls_section(
			'wdb_settings',
			[
				'label'     => esc_html__( 'Zenix General', 'zenix-essential' ),
				'condition' => [
					'_skin' => 'skin-wdb-accordion',
				],
			]
